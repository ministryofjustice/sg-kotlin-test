...
[![repo standards badge](https://img.shields.io/badge/endpoint.svg?&style=flat&logo=github&url=https%3A%2F%2Foperations-engineering-reports.cloud-platform.service.justice.gov.uk%2Fapi%2Fv1%2Fcompliant_public_repositories%2Fsg-kotlin-test)](https://operations-engineering-reports.cloud-platform.service.justice.gov.uk/public-report/sg-kotlin-test "Link to report")
[![CircleCI](https://circleci.com/gh/ministryofjustice/sg-kotlin-test/tree/main.svg?style=svg)](https://circleci.com/gh/ministryofjustice/sg-kotlin-test)
[![Docker Repository on Quay](https://img.shields.io/badge/quay.io-repository-2496ED.svg?logo=docker)](https://quay.io/repository/hmpps/sg-kotlin-test)
[![API docs](https://img.shields.io/badge/API_docs_-view-85EA2D.svg?logo=swagger)](https://sg-kotlin-test-dev.hmpps.service.justice.gov.uk/webjars/swagger-ui/index.html?configUrl=/v3/api-docs)
...
Our security policy is located [here](https://github.com/ministryofjustice/sg-kotlin-test/security/policy).
...
## Renaming from Sg Kotlin Test - github Actions
...
```bash
docker compose pull && docker compose up --scale sg-kotlin-test=0
```
