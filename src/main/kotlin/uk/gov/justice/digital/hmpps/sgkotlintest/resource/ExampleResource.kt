package uk.gov.justice.digital.hmpps.sgkotlintest.resource
...
import uk.gov.justice.digital.hmpps.sgkotlintest.service.ExampleApiService
...
class ExampleResource(private val exampleApiService: ExampleApiService) {
  ...
  @Operation(
    ...
    security = [SecurityRequirement(name = "sg-kotlin-test-ui-role")],
    responses = [
